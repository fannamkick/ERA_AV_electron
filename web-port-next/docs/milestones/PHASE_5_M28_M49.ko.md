...
| M29 | 구매형 상점 listing과 구매 결과 | strict closure 완료. source 206 중 M29-owned 83은 implemented-verified, 123개는 approved-excluded 및 M30/M31/M32/M34/M35/M37/M47/M48/M49 수신 책임. | 비구매 item/use/equipment/recruit/event row를 M29 완료로 세지 않는다. |
...
| M31 | 영입 listing과 인물 생성 결과 | strict closure 완료. source 237 중 M31-owned 127은 implemented-verified, character seed/lifecycle/event/source-review 110개는 approved-excluded 또는 수신 owner 책임. | M32 20, M33 74, M34 4, M35 1, M47 3은 M31 완료가 아니다. |
...
Strict closure update, 2026-05-02:
- M29 is complete under the source-unit manifest rule.
...
- [x] `data/coverage/milestones/M29-closure.json` strict 갱신. sourceUnitTotal 206, ownedTotal 83, implemented 83, approvedExcludedFromM29 123, transferredOut 0, blocker/missing/unapproved 0
