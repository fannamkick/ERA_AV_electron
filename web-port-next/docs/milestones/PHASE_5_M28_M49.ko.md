...
| M37 | 업무/창관/특수 업무 | 기존 구현 이력은 있으나 strict manifest 기준 total 463, implemented 294, blocked 169. 조건/결과/roundtrip 검증을 다시 닫아야 한다. | mapped save/session/calculation row는 업무 완료가 아니다. |
