# M45. Power growth, transfer, and common bonus
...
Old closure title: Power growth, transfer, and common bonus
...
### M45-A. Power/ability growth transaction
...
### M45-B. Transfer/inheritance source effects
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M45-C. Common bonus calculation
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M45-D. State-family writes and save roundtrip
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M45-E. Downstream display/story contracts
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
- Source-unit manifest: web-port-next/data/coverage/manifests/M45-source-units.json
- Closure artifact: web-port-next/data/coverage/milestones/M45-closure.json
- Gap audit: web-port-next/data/coverage/audits/M45-gap-audit.json
- Phase index: web-port-next/docs/milestones/PHASE_5_M28_M49.ko.md

## Source Inventory Summary

- Total source units: 2
- Implemented-verified under old rules:
- Approved-excluded under old rules:
- Blocked under old rules: 1
...
|---|---|---|---|---|---|---|
| TODO | TODO | M45 | TODO | TODO | TODO | open |
