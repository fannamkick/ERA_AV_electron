...
Old closure title: Mission flow
...
### M46-A. Mission listing and dynamic dispatch family
...
### M46-B. Mission accept/progress/failure/success transaction
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M46-C. Deadline and turn-hook interaction
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M46-D. Reward/economy/world state effects
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
### M46-E. Downstream event/story contracts
- Status: open-under-new-split-review
- Original entrypoints/source units: to be filled from canonical manifest and direct original review.
- Required runtime effects: to be filled before implementation/reclosure.
- Implementation claim: none recorded in this split doc yet.
...
- Source-unit manifest: web-port-next/data/coverage/manifests/M46-source-units.json
- Closure artifact: web-port-next/data/coverage/milestones/M46-closure.json
- Gap audit: web-port-next/data/coverage/audits/M46-gap-audit.json
- Phase index: web-port-next/docs/milestones/PHASE_5_M28_M49.ko.md

## Source Inventory Summary

- Total source units: 1
...
|---|---|---|---|---|---|---|
| TODO | TODO | M46 | TODO | TODO | TODO | open |
