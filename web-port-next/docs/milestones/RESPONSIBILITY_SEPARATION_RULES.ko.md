...
| M37 | work execution owner | 업무 dispatch/정의 실행 80개, definition 8개, 업무 결과 write-effect 21개는 검증됨. 완료 판정은 남은 save/session/calculation/source-address row 148개까지 닫아야 함 | mapped 175개를 완료로 세어 업무 계산/결과 누락을 숨김 |
