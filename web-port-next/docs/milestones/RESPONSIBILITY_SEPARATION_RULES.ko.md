...
| M37 | work execution owner | 업무 dispatch/정의 실행 80개와 definition 8개는 검증됨. 완료 판정은 save/session/calculation 결과 row 169개까지 닫아야 함 | mapped 175개를 완료로 세어 업무 계산/결과 누락을 숨김 |
