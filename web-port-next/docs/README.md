...
- 현재 마일스톤의 상세 체크리스트는 `milestones/README.ko.md`에서 해당 phase 문서를 찾아 그 section만 좁게 조회한다. 완료 판정 전에는 `milestones/RESPONSIBILITY_SEPARATION_RULES.ko.md`를 확인한다. `NEW_PORT_MILESTONES.ko.md`는 공통 규칙과 phase 경계만 본다.
