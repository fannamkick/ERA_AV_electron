...
- M29 is now blocked after source-owner reclaim audit.
- M30 is strictly closed.
- M31 is now blocked after source-owner reclaim audit.
...
M31 is blocked under the source-unit manifest rule after source-owner reclaim audit.

- Manifest: `data/coverage/manifests/M31-source-units.json`
- Closure: `data/coverage/milestones/M31-closure.json`
- M31 summary: total 237, implemented-verified 127, approved-excluded 19, blocked 91, scope-redesign-required 0, `completedAllowedNow: false`.
...
M29 is blocked under the source-unit manifest rule after source-owner reclaim audit.

- Manifest: `data/coverage/manifests/M29-source-units.json`
- Closure: `data/coverage/milestones/M29-closure.json`
- M29 summary: total 206, implemented-verified 83, approved-excluded 105, blocked 18, scope-redesign-required 0, `completedAllowedNow: false`.
...
- M30 was closed later; M31 has since been reopened as blocked by source-owner reclaim audit.
...
- M31: `data/coverage/manifests/M31-source-units.json`, total 237, implemented-verified 127, approved-excluded 19, blocked 91, completedAllowedNow false.
...
Current criteria: M29 and M31 are blocked after source-owner reclaim audit. M28 needs exact M47 inbound correction. M32~M36 are strict-closed. Do not mistake M37~M41 blocked/scope-redesign-required units for completion. M42 is still not resumed.

New sessions should continue with M28 exact inbound correction, M29 reclaim 18, M31 reclaim 91, and M37~M41 source-unit manifest closure correction. M42 command effect 0~34 resumes only after that.
...
- M29는 source-owner reclaim audit 후 blocked다. `unit:M29:shop-purchase` 206행 중 implemented-verified 83, approved-excluded 105, blocked 18이다. 즉시 사용 item 효과는 M30이지만 item 30/31/38/39/40/41/42/43/52의 listing/ITEMSALES/구매 선택은 M29 책임이다.
...
- M31은 source-owner reclaim audit 후 blocked다. source 237행 중 implemented-verified 127, approved-excluded 19, blocked 91이다. downstream field semantics는 M32/M33/M34/M35가 닫더라도 recruit creation result integration은 M31 책임이다.
...
New sessions should continue with M28/M29/M31 correction and M37~M41 source-unit closure work. M28 has 3 M47 inbound rows that need exact receiver manifest correction. M29 has 18 immediate-use purchasable listing rows that are M29-owned. M31 has 91 recruit creation integration/self-exclusion rows that are M31-owned. M38~M41 closure files are `blocked`, not completed. M42 command effect 0~34 resumes only after these blockers are actually closed or explicitly left blocked/scope-redesign-required.
- M28~M36 manifest 기준 현재 상태: M29와 M31은 blocked로 되돌렸다. M28은 M47 inbound 3개 정확 수신 correction이 필요하다. M32~M36은 strict-closed다. M29/M30/M32/M33 excluded row는 수신 manifest에 blocked inbound로 명시되어 후속 owner 완료를 막는다.
...
24. M29 아이템 상점과 구매는 source-owner reclaim audit 후 blocked다. total 206, implemented-verified 83, approved-excluded 105, blocked 18이다.
...
26. M31 영입 listing과 인물 생성은 source-owner reclaim audit 후 blocked다. total 237, implemented-verified 127, approved-excluded 19, blocked 91이다.
...
39. 다음 작업은 M28 exact inbound correction, M29 reclaim 18, M31 reclaim 91, M37~M41 실제 기능 closure, 그 다음 M42 훈련 command 효과 0~34 구현이다. command 0~34의 source 계산, 결과 owner, 성공/불가/취소/session cleanup을 원본 기준으로 닫는다.
