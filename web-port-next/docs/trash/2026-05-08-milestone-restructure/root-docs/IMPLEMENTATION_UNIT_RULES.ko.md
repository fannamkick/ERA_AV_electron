...
이 문서는 M18의 기준 문서다. 목적은 M28~M49에서 기능군을 전수 구현할 때 작업자가 임의로 범위를 넓히거나, 원본 근거/실패 경로/coverage 갱신 없이 완료 처리하지 못하게 하는 것이다.
...
- M28: 메인 route/action/menu/view
- M29: 구매 상점/listing/구매 결과
- M30: 아이템 사용/특수 효과
- M31: 영입 listing/인물 생성
- M32: 인물 원형/identity/lifecycle
- M33: 신체/능력/소질/경험/파라미터
- M34: 관계/CFLAG/장비/의복
- M35: 턴/시간/hook
- M36: 방문/시설
- M37: 업무/창관
...
- M40: 훈련 메뉴/session
- M41: 훈련 가능 조건
- M42~M44: 훈련 command 효과와 후처리
- M45: 능력 상승/휴식/공통 유지보수
- M46: 미션
- M47: 세계/이벤트/스토리 진행
- M48: 엔딩/계승/전역 상태
- M49: 정보/도움말/설정/남은 기능
