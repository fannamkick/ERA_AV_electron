...
| M37 | `data/coverage/manifests/M37-source-units.json` | 463 | 324 | 139 | 0 | false |
...
- source-unit manifest 기준 total 463, implemented-verified 324, blocked 139이다. old `mapped` 175는 완료 근거가 아니다.
...
- 2026-05-07 정정: `coverage:work`는 더 이상 mapped 175개를 완료로 세어 M37 closure를 `completed`로 덮어쓰지 않는다. strict manifest 기준 total 463, implemented-verified 324, blocked 139이 유지되며 `gate:milestone-scope-closure -- M37`는 실패해야 정상이다.
...
- M37 work coverage/gate/smoke는 통과하지만 strict closure는 blocked 139 때문에 미완료다.
