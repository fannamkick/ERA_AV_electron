...
function createMainRows() {
  return [
    ...
    implementedRow({
      ...
      endRoute: 'mainMenu',
      runtimeRoute: 'itemShop',
      runtimeAction: 'shop/selectUseItem; shop/selectUseTarget; shop/confirmUseItem; shop/cancelUseItem',
      viewBuilder: 'buildItemShopView',
      handlerOwner: 'src/features/itemShop.ts',
      definitionReads: ['definitions.items'],
      stateWrites: ['GameState.inventory.itemCounts', 'GameState.body.byCharacterId', 'GameState.equipment.byCharacterId'],
      sessionWrites: ['GameSession.shop'],
      successSmokeId: 'smoke:item-use',
      failureSmokeId: 'smoke:item-use:missing-selection',
      cancelSmokeId: 'smoke:item-use:cancel',
      saveRoundtripId: 'smoke:item-use:save-roundtrip',
      classification: 'item-use-effects',
      notes: 'M30 closes immediate item use and special item classification; remaining clothing/equipment packs are owned by M34.',
    }),
    implementedRow({
    ...
    implementedRow({
      ...
      sourceLabel: '재단/의복',
      endRoute: 'mainMenu',
      runtimeRoute: 'wardrobe',
      runtimeAction: 'main/openWardrobe; wardrobe/toggleClothing; wardrobe/cancel',
      viewBuilder: 'buildWardrobeView',
      handlerOwner: 'src/features/socialEquipmentCflag.ts',
      definitionReads: ['definitions.legacyCharacterFlagDefinitions', 'definitions.characters.initialState.characterFlags'],
      stateWrites: ['GameState.equipment.clothing'],
      sessionWrites: ['GameSession.ui'],
      successSmokeId: 'smoke:social-equipment-cflag:wardrobe-route',
      failureSmokeId: 'smoke:social-equipment-cflag:missing-flag',
      cancelSmokeId: 'smoke:social-equipment-cflag:wardrobe-cancel',
      saveRoundtripId: 'smoke:social-equipment-cflag:save-roundtrip',
      classification: 'implemented-main-menu-child',
    }),
    blockerRow({
