...
export interface TrainingContext {
  ...
  isAssistantPlay: boolean;   // 조수 플레이 모드 여부 (alias)
  player: any;                // PLAYER
  assi: any;                  // 조수 객체
  assistant: any;             // 조수 객체 (alias)

  // ============================================================================
  // 대상 캐릭터
  // ============================================================================
  target: Character;          // 현재 조교 대상 캐릭터

  // ============================================================================
  // 별칭 (호환성)
  // ============================================================================
  parameters: number[];       // params의 alias
  experience: number[];       // exp의 alias
  globalFlags: number[];      // flags의 alias
  ...
  equipment: number[];        // 장비 상태 TEQUIP:0~299
...
export interface Character {
  ...
  // 캐릭터 플래그 (CFLAG:n)
  // ============================================================================
  cflag: number[];            // CFLAG:0~299 (캐릭터 고유 플래그)
  cflags: number[];           // 별칭 (deprecated)
  flags: number[];            // 별칭 (deprecated)

  // ============================================================================
  // 소질 (TALENT:n)
  // ============================================================================
  talent: number[];           // TALENT:0~299 (캐릭터 소질)

  // ============================================================================
  // 능력치 (ABL:n)
  // ============================================================================
  abilities: number[];        // ABL:0~299 (캐릭터 능력치)
